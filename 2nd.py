...
face_cas = cv2.CascadeClassifier('C:\\Users\\ankit\\AppData\\Local\\Programs\\Python\\Python36\\Lib\\site-packages\\cv2\\data\\haarcascade_frontalface_default.xml')
...
f_01 = np.load('face_01.npy').reshape((20, 50*50*3))	# Ankit
